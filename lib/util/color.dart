...
class AppColors {
  ...
  static const darkNavy = Color(0xFF202124);
  static const background = Color(0xFF0F1923); // extracted from image background
  static const riseRed = Color(0xFFFF5252); // 상승 시그널
